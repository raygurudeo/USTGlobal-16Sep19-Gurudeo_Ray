...
public class App {
	...
	public static void main( String[] args ) {
		...
		/*
		 * will print same object address by default spring always create singleton
		 * object or bean configuration So should use scope attribute in
		 * 
		 * <bean id="hello" class="com.ustglobal.springcore.di.Hello" scope="prototype">
		 * <property name="msg" value="I love java"/> </bean>
		 */
