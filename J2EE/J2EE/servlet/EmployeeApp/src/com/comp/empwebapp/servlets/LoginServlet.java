...
@WebServlet("/login")	// alternative of configuring servlet in web.xml
public class LoginServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		String rememberMe = req.getParameter("rememberData");
		...
		if(info == null) {
			...
			out.println("<h1 class='alert-warning' style='color:red'>Invalid id or password</h1>");
